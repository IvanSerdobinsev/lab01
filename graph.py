...
ax1.plot(logN, av_bin_times, 'b-', linewidth=2, label='Среднее время', marker='o', markersize=4)
...
ax2.plot(logN, worst_bin_times, 'r-', linewidth=2, label='Худшее время', marker='s', markersize=4)
ax2.plot(logN, approx_worst_bin, 'r--', linewidth=2)
...
ax3.plot(N, worst_times, 'm-', linewidth=2, label='Линейный поиск', marker='s', markersize=3)
ax3.plot(N, worst_bin_times, 'r-', linewidth=2, label='Бинарный поиск', marker='o', markersize=3)
ax3.set_xlabel('N', fontsize=12)
ax3.set_ylabel('Время (мкс)', fontsize=12)
...
ax4.plot(N, av_times, 'g-', linewidth=2, label='Среднее время', marker='o', markersize=3)
ax4.plot(N, worst_times, 'm-', linewidth=2, label='Худшее время', marker='s', markersize=3)
ax4.plot(N, approx_av_lin, 'g--', linewidth=1.5)
ax4.plot(N, approx_worst_lin, 'm--', linewidth=1.5)
ax4.set_xlabel('N', fontsize=12)
ax4.set_ylabel('Время (мкс)', fontsize=12)
